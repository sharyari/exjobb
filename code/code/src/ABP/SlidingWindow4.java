...
public class SlidingWindow4 {
	public static void main(String[] args) {
		...
		sender.addTransition(2, 5, a, "?", 0);
		sender.addTransition(3, 6, a, "?", 0);
		sender.addTransition(4, 7, a, "?", 0);

		sender.addTransition(5, 6, Actions.SND);
		sender.addTransition(6, 7, Actions.SND);
		sender.addTransition(7, 8, Actions.SND);
		sender.addTransition(6, 6, m, "!", 1);
		sender.addTransition(7, 7 ,m, "!", 21);
		sender.addTransition(8, 8, m, "!", 321);
		sender.addTransition(6, 9, a, "?", 1);
		sender.addTransition(7, 10, a, "?", 1);
		sender.addTransition(8, 11, a, "?", 1);

		sender.addTransition(9, 10, Actions.SND);
		sender.addTransition(10, 11, Actions.SND);
		sender.addTransition(11, 12, Actions.SND);
		sender.addTransition(10, 10, m, "!", 2);
		sender.addTransition(11, 11 ,m, "!", 32);
		sender.addTransition(12, 12, m, "!", 032);
		sender.addTransition(10, 13, a, "?", 2);
		sender.addTransition(11, 14, a, "?", 2);
		sender.addTransition(12, 15, a, "?", 2);

		sender.addTransition(13, 14, Actions.SND);
		sender.addTransition(14, 15, Actions.SND);
		sender.addTransition(15, 16, Actions.SND);
		sender.addTransition(14, 14, m, "!", 3);
		sender.addTransition(15, 15 ,m, "!", 03);
		sender.addTransition(16, 16, m, "!", 103);
		sender.addTransition(14, 1, a, "?", 3);
		sender.addTransition(15, 2, a, "?", 3);
		sender.addTransition(16, 3, a, "?", 3);
		...
		receiver.addTransition(1, 1, a, "!", 3);
		...
		receiver.addTransition(8, 1, Actions.RCV);
		...
		observer.addState(new State(5, StateType.BAD));
		...
		observer.addTransition(1, 5,Actions.RCV);
