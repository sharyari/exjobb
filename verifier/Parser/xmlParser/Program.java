...
public class Program {
	...
	public Program(String name, int number, Vector <State>states, Vector<Rule> rules, Vector<Action> actions, Vector<Channel> channels, Vector<Symbol> symbols){
		friendlyName = name;
		this.rules = rules;
	...
	public Vector<Action> synchronize(String action){
