...
\label{model}
Formalized by Cousot and Cousot\cite{cousot1977}, abstract interpretation techniques are techniques to approximating programs. Using information about the control and data flow, i.e. the transitions, the program can be verified while verifying only a part of the full transition system, more precisely until a fixpoint is reached.
