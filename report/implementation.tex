...
In this section, we show how to implement the algorithm in \todo{Ref} an efficient way. We do this by beginning with a naive algorithm computing the configurations, and then step by step locating and addressing the performance issues.
