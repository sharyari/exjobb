...
%\todo[inline]{You commented that the change to using $X$ rather than $V$ as in the last chapter is confusing. In my opinion, this distinction makes it more clear that $X$ denotes something that is changing continously, whereas $V$ in this chapter is only used to denote the ''static'' set $V_k$}
